      ...
      <group position={cardPosition}>
        ...
        <RigidBody position={initialJointPositions[3]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          <group
            ...
            <Image url="/assets/profile.png" position={[0, 0.5229, 0.012]} scale={[0.67, 0.93, 1]} transparent={true} />
            <Image url="/assets/profile.png" grayscale={1} position={[0, 0.5229, -0.005]} rotation={[0, Math.PI, 0]} scale={[0.67, 0.93, 1]} transparent={true} />
